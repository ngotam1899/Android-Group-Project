...
public class QuanAnListDetailAdapter extends RecyclerView.Adapter<QuanAnListDetailAdapter.MyViewHolder> {
    Context context;
    List<MonAn> list;

    public QuanAnListDetailAdapter(Context context, List<MonAn> list) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new QuanAnListDetailAdapter.MyViewHolder(view);
    }
